...
def generate_giscus_script():
    """Generate Giscus comments script with theme matching"""
    return '''
        <!-- Giscus Comments -->
        <div class="comments-section">
            <h2 class="comments-title">💬 Comments</h2>
            <p class="comments-description">Join the discussion! Comments are powered by GitHub Discussions. No account required to view.</p>
...
def generate_site():
    ...
    giscus_script = generate_giscus_script()
    ...
    for filename in sorted(os.listdir(posts_dir), reverse=True):
        if filename.endswith('.md'):
            ...
            # Generate individual post page with Giscus comments
...
<body>
    ...
    print(f'💬 Giscus comments enabled for all articles')
    print(f'\n📊 Categories:')
